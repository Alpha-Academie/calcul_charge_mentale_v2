...
class StudentResultsPage extends StatelessWidget {
  ...
  const StudentResultsPage({super.key, required this.totalHours}); // Ajout de const et super.key
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.of(context).push(
                      MaterialPageRoute(builder: (context) => const StudentFinalPage()), // Ajout de const ici
                    );
                  },
