...
class SecurityPage extends StatelessWidget {
  const SecurityPage({super.key}); // Utilisation du super paramètre pour la clé

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Sécurité et Confidentialité', style: TextStyle(color: Colors.white)),
      ),
      body: Padding(
